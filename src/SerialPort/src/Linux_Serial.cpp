...
SerialInfo::SerialInfo(const SerialInfo& info) : port_name(info.port_name),
                                                 device(info.device) {
}
...
SerialInfo::SerialInfo(const std::string& _port) : port_name(_port) {
...
SerialInfo::SerialInfo(const std::string& _port, const std::string& _device_name) : port_name(_port),
                                                                                    device(_device_name) {
}
